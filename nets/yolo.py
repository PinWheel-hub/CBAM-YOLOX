...
class YOLOPAFPN(nn.Module):
    def __init__(self, depth = 1.0, width = 1.0, in_features = ("dark3", "dark4", "dark5"), in_channels = [256, 512, 1024], depthwise = False, act = "silu"):
        ...
        self.att_1 = attention_block[1](int(in_channels[0] * width))  # 对应dark3输出的256维度通道
        self.att_2 = attention_block[1](int(in_channels[1] * width))  # 对应dark4输出的512维度通道
        self.att_3 = attention_block[1](int(in_channels[2] * width))  # 对应dark5输出的1024维度通道
